import {AbstractCockroachLabsResource} from "./abstract-cockroachlabs-resource";
...
class TestAbstractCockroachLabsResource extends AbstractCockroachLabsResource<BaseModel, {}, {}, {}, {}> {
...
describe('AbstractCockroachLabsResource', () => {
    describe('processRequestException', () => {
        let testInstance: TestAbstractCockroachLabsResource;

        beforeAll(() => {
            testInstance = new TestAbstractCockroachLabsResource('foo', BaseModel, undefined, undefined, BaseModel);
        });
        ...
        it.each([
            ...
            let axiosError: CockroachLabsError = {
